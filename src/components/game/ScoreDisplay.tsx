  ...
  return (
    <div className="flex items-center gap-4 flex-wrap justify-center">
      ...
      >
        ...
        <span className="font-bold text-primary-700">{score.toLocaleString()}</span>
      ...
      {/* Best Streak */}
      <motion.div
        className="flex items-center gap-2 bg-gradient-to-r from-primary-500 to-primary-600 px-4 py-2 rounded-full shadow-md text-white"
        whileHover={{ scale: 1.05 }}
      >
        ...
        <span className="text-primary-100 text-sm">best</span>
      </motion.div>
    </div>
  );
}
