        ...
        <div className="flex items-center justify-between h-24">
          ...
          >
            ...
            <div className="relative">
              ...
              />
              <motion.div
                className="relative w-12 h-12 bg-gradient-to-br from-primary-400 to-primary-600 rounded-xl flex items-center justify-center shadow-md"
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onOpenStats && (
              <motion.button
                onClick={onOpenStats}
                className="p-2.5 rounded-xl bg-primary-50 hover:bg-primary-100 text-primary-600 transition-colors"
            ...
            {onOpenLeaderboard && (
              <motion.button
                ...
                className="p-2.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-600 transition-colors"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
